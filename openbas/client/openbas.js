...
if (Meteor.isClient) {
  ...
  Template.smap_plot.plot_data = [{ tagsURL: 'http://new.openbms.org/backend/api/query?', dataURLStart: 'http://miranda.cs.berkeley.edu:9000/data/uuid/' }, function (inst) { instances.push(inst); inst.imethods.selectStreams([{"Path": "/keti/FAKE/temperature", "uuid": "39ef31da-d369-5d90-bcdf-f6245ab0387aFAKE", "Properties": {"UnitofTime": "s", "Timezone": "America/Los_Angeles", "UnitofMeasure": "C", "ReadingType": "double"}, "Metadata": {"Building": "CIEE", "Room": "General Area East", "Floor": "2", "SourceName": "CIEE KETImotes", "moteid": "1665", "Site": "51320145-1f5d-11e4-bd08-6003089ed1d0", "System": "Monitoring", "Hvaczone": "General Area", "Location": {"Building": "CIEE Office", "Room": "General Area East"}, "Type": "Sensor"}}, {"Path": "/tests/Data Range Test", "Metadata": {"SourceName": "Fake Data", "Instrument": {"ModelName": "A Python Program"}}, "uuid": "fake-data", "Properties": {"UnitofTime": "ns", "Timezone": "America/Phoenix", "UnitofMeasure": "N", "ReadingType": "long"}}]); }, function () { instances[instances.length - 1].imethods.selectStreams([{"Path": "/keti/1665/temperature", "uuid": "39ef31da-d369-5d90-bcdf-f6245ab0387a", "Properties": {"UnitofTime": "s", "Timezone": "America/Los_Angeles", "UnitofMeasure": "C", "ReadingType": "double"}, "Metadata": {"Building": "CIEE", "Room": "General Area East", "Floor": "2", "SourceName": "CIEE KETImotes", "moteid": "1665", "Site": "51320145-1f5d-11e4-bd08-6003089ed1d0", "System": "Monitoring", "Hvaczone": "General Area", "Location": {"Building": "CIEE Office", "Room": "General Area East"}, "Type": "Sensor"}}]); }];
}
